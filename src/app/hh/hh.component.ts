...
export class HHComponent implements OnInit {
  list_HH : any = [];
  error_msg:string = '';
  constructor(private titleService:Title,private metaService:Meta,public CentreTraitServ : CentreTraitService, public router : Router) {
    this.titleService.setTitle("InfoCovidMada : Liste des Hôtels-Hôpitaux Covid-19");
    this.metaService.updateTag({name:'description',content:'Voici une liste des HH '}); 
  }
